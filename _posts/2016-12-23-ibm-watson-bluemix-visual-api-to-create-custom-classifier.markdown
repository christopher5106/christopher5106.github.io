...
After a few hours of training, we get a **top-1 accuracy of 87% and a top-5 accuracy of 97.6% with our own model**. See transcript [here]({{ site.url }}/img/log-resnet-101-food-101-classes.txt).
