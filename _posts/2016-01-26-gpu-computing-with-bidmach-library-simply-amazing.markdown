...
We'll see in this article how to install the library on Mac OS, or run an EC2 instance with the library, as well as a few first operations. For a [deeper tutorial : my next article](//christopher5106.github.io/big/data/2016/02/04/bidmach-tutorial.html).
