...
- it's **continuous deployment**, the pattern that deploying many times a day small upgrades reduces the risk of critical failure, usually the consequence of infrequent deployments of bigger upgrades.
