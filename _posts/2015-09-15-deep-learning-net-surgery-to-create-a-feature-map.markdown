...
Let's re-use our classifier net for [license plate letters](http://christopher5106.github.io/computer/vision/2015/09/14/comparing-tesseract-and-deep-learning-for-ocr-optical-character-recognition.html) to create a feature map of images including more than a letter.

![png]({{ site.url }}/img/feature_map/Example_20_1.png)

We will replace innerproducts with convolutions with the same parameters in order to create a map as on the left picture.
